                    ...
                    <div class="row clearfix collapse">
                        ...
                        <div class="small-6 columns text-right">
                            <div class="cta-wrapper apply-now-wrapper">
                                <a class="border-btn" href="http://app.orionsystem1.com/employment-application" target="_blank">Apply Now</a>
                            </div>
                                    ...
                                    <div class="small-12 large-4 columns">
                                        <nav id="primary">
                                            <ul class="menu vertical">
                                                <li class="menu-item-page-cta"><a href="http://app.orionsystem1.com/employment-application"  target="_blank">Apply Now</a></li>
                                                ...
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                                    <a className={this.state.subMenuOpen ? 'opened' : ''} onClick={this.toggleSubmenu} href="#">Stories<span class="expand-toggle"></span></a>
                                                    <ul class="sub-menu">
                                                        <li><Link to='/claudia-robbins'>Claudia Robbins</Link></li>
                                                        <li><Link to='/stephen-robbins'>Stephen Robbins</Link></li>                                                    
                                                        <li><Link to='/joana-manching'>Joana Manching</Link></li>                                                    
                                                    </ul>
                                                </li>			
