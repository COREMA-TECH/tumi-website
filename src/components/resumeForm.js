                                    ...
                                    <form action="/contact/#wpcf7-f359-o1" method="post" class="wpcf7-form" novalidate="novalidate">
                                        ...
                                        <div class="row">
                                            <div class="small-6 columns">
                                                <label> Position ID <br />
                                                <span class="wpcf7-form-control-wrap position-id"><input value={this.state.positionId} onChange={this.handleChange} type="text" name="positionId" size="40" class="wpcf7-form-control wpcf7-text   Tumi-contactInput" aria-required="true" aria-invalid="false" placeholder="Position Id" /></span> </label>
                                            </div>
                                            <div class="small-6 columns">
                                                <label> Position Name <br />
                                                <span class="wpcf7-form-control-wrap position-name"><input value={this.state.positionName} onChange={this.handleChange} type="text" name="positionName" size="40" class="wpcf7-form-control wpcf7-text   Tumi-contactInput" aria-required="true" aria-invalid="false" placeholder="Position name" /></span> </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="small-6 columns">
                                                <label> Your Name <br />
                                                <span class="wpcf7-form-control-wrap name"><input value={this.state.name} onChange={this.handleChange} type="text" name="name" size="40" class="wpcf7-form-control wpcf7-text   Tumi-contactInput" aria-required="true" aria-invalid="false" placeholder="Your Name" /></span> </label>
                                            </div>
                                            <div class="small-6 columns">
                                                <label> Contact Number <br />
                                                <span class="wpcf7-form-control-wrap contact-number"><input value={this.state.contactNumber} onChange={this.handleChange} type="text" name="contactNumber" size="40" class="wpcf7-form-control wpcf7-text   Tumi-contactInput" aria-required="true" aria-invalid="false" placeholder="Contact Number" /></span> </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="small-12 columns">
                                                <label> Email Address <br />
                                                <span class="wpcf7-form-control-wrap email"><input value={this.state.email} onChange={this.handleChange} type="email" name="email" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email   wpcf7-validates-as-email Tumi-contactInput" aria-required="true" aria-invalid="false" placeholder="Email Address" /></span> </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="small-12 columns">
                                                <label> Resume: <br />
                                                <span class="wpcf7-form-control-wrap zip"><input type="file" ref={this.fileInput} class="wpcf7-form-control wpcf7-text Tumi-contactInput" aria-invalid="false" /></span> </label>
                                            </div>
                                        </div>                                                                                                              
                                        <div class="row">
                                            <div class="small-12 columns">
